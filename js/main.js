...
// Scroll reveal
const revealEls = $$('.hero .wrap > *, .hero-grid > *, .section-head, .filters, .case, .pillar-grid > div, .stats .wrap > div, .project-facts .wrap > div, .xp-item, .story-row, .cv-item, .cv-h2, .block, .beyond-grid img, .facts, .form, .project-nav a, .workbook, .shots img, .slides img');
